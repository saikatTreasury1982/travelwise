...
import { reorderActivities, reorderCategories, reorderRanges } from '@/app/lib/services/itinerary-service';
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  else if (body?.kind === 'range') await reorderRanges(ctx, Number(id), ids);
